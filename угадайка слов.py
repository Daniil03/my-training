...
def play(word):
    ...
    while tries != 0:
        s = input('Введите букву или слово: ').upper()
        word_c = list(word_completion)
        if 'А' <= s <= 'Я':
            if len(s) == 1:
                if s in guessed_letters:
                    ...
                    if s in word:
                        print('Вы угадали букву: ', s)
                        summ = [i for i in range(len(word)) if word[i] == s]
                        for i in summ:
                            word_c[i] = s
                            word_completion = ''.join(word_c)
                        ...
                        tries -= 1
                        print('Вы не угадали букву! Осталось попыток: ', tries)
                        print(display_hangman(tries))
                        print(word_completion)
                        guessed = False
            elif len(s) > 1:
                if s in guessed_words:
                    ...
                    if s == word:
                        ...
                        tries -= 1
                        print('Вы не угадали слово! Осталось попыток: ', tries)
                        print(display_hangman(tries))
                        print(word_completion)
                        guessed = False
            if guessed:
                print('Поздравляем, вы угадали слово! Вы победили! Хотите продолжить? Д(Да) или Н(нет)')         
                if input().lower() == 'д':
                    tries = 6
                    guessed = False
        ...
        print('Попытки закончились! Правильное слово: ', word)
        print('Хотите продолжить? Д(Да) или Н(нет)')
        if input().lower() == 'д':
            tries = 6
            guessed = False
            play(get_word(word_rus))
